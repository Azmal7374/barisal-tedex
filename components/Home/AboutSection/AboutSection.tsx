        ...
        <div className="md:w-2/3">
          ...
          <div className="flex flex-col items-start gap-[24.325px]">
            <div>
              ...
              >
               Our mission is to inspire and innovate within the university community, uncovering new ideas and to share the latest research in their local 
areas that spark conversations in their communities. TEDx University Of 
Barishal is a fully student-run youth organization at the University of Barishal - our mission is to inspire and innovate within the university communit.
              </p>
            </div>
            <Button
