...
const BrowseTalksSection = () => {
  return (
    <section className="py-[60px] px-[16px] sm:px-[100px] sm:py-[100px] bg-[#F5F5F5]">
      <h2
        className={`${bebasNeue.className}  text-[#111111] text-[38px] leading-[120%] sm:leading-[140%] sm:text-[52px] uppercase font-[400]`}
      >
        Browse Talks
      </h2>
