...
const Footer = () => {
  return (
    <div className="bg-[#FBE9E9]">
      <footer className=" py-[10px] px-[16px] sm:px-[100px] sm:[py-100px]">
        {/* Container */}
        <div className="container mx-auto flex flex-col lg:flex-row gap-[32px] lg:gap-[160px] items-start">
          ...
          <div className="flex flex-col gap-[19px]">
            <h3
              className={`${inter.variable} text-[16px] text-[#111111] font-semibold`}
            >
              Sitemap
            </h3>
            <ul
              className={`${inter.variable} text-[14px] text-[#11111180] space-y-2`}
            >
          ...
          <div className="flex flex-col gap-[19px]">
            ...
            <p className={`${inter.variable} text-[14px] text-[#11111180]`}>
          ...
          <div className="flex flex-col gap-[19px] items-start">
            ...
            <div className="flex items-center text-[20px] underline">
              ...
              <a
                ...
                className={`${inter.variable}  text-[#111111] underline`}
              >
                butedx@gmail.com
              </a>
            </div>
      ...
      <div className="relative mt-[30px] sm:mt-[20px] text-center ">
        <h1
          className={`${bebasNeue.className} text-[62px] md:text-[120px] lg:text-[188px] text-[#111111] sm:tracking-[-2.756px]   `}
        >
          TedxBarishaluniversity
        </h1>
      </div>
    </div>
  );
